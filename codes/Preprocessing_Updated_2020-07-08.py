    ...
    for file in os.listdir(inFolder):
        if file.endswith(".shp"):
            ...
            if caps&QgsVectorDataProvider.AddAttributes:
                ...
                layer.dataProvider().addAttributes([QgsField('trueDate',QVariant.String)])
...
s,t="E:\\Outputs\\original", "E:\\Outputs\\tagwise"
splitData(s,t,"tag_ident")
#Preprocess data
sourceFolder="E:\\Outputs\\original"
preprocess(sourceFolder,metadataDir)
